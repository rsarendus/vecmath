...
public final class VecOps {
    ...
    public static double apply(DoubleBinaryOperator consolidator, Vector2.Accessible vector) {
        return consolidator.applyAsDouble(vector.x(), vector.y());
    }

    public static double apply(DoubleTernaryOperator consolidator, Vector3.Accessible vector) {
        return consolidator.applyAsDouble(vector.x(), vector.y(), vector.z());
    }

    public static double apply(DoubleQuaternaryOperator consolidator, Vector4.Accessible vector) {
        return consolidator.applyAsDouble(vector.x(), vector.y(), vector.z(), vector.w());
    }
    ...
    public static double apply(DoubleUnaryOperator operator, DoubleBinaryOperator consolidator, Vector2.Accessible operand) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(operand.x()),
                operator.applyAsDouble(operand.y())
        );
    }
    ...
    public static double apply(DoubleBinaryOperator operator, DoubleBinaryOperator consolidator, Vector2.Accessible left, Vector2.Accessible right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left.x(), right.x()),
                operator.applyAsDouble(left.y(), right.y())
        );
    ...
    public static double apply(DoubleBinaryOperator operator, DoubleBinaryOperator consolidator, Vector2.Accessible left, double right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left.x(), right),
                operator.applyAsDouble(left.y(), right)
        );
    ...
    public static double apply(DoubleBinaryOperator operator, DoubleBinaryOperator consolidator, double left, Vector2.Accessible right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left, right.x()),
                operator.applyAsDouble(left, right.y())
        );
    ...
    public static double apply(DoubleTernaryOperator operator, DoubleBinaryOperator consolidator, Vector2.Accessible left, Vector2.Accessible middle, Vector2.Accessible right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left.x(), middle.x(), right.x()),
                operator.applyAsDouble(left.y(), middle.y(), right.y())
        );
    ...
    public static double apply(DoubleTernaryOperator operator, DoubleBinaryOperator consolidator, Vector2.Accessible left, Vector2.Accessible middle, double right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left.x(), middle.x(), right),
                operator.applyAsDouble(left.y(), middle.y(), right)
        );
    ...
    public static double apply(DoubleTernaryOperator operator, DoubleBinaryOperator consolidator, Vector2.Accessible left, double middle, Vector2.Accessible right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left.x(), middle, right.x()),
                operator.applyAsDouble(left.y(), middle, right.y())
        );
    ...
    public static double apply(DoubleTernaryOperator operator, DoubleBinaryOperator consolidator, Vector2.Accessible left, double middle, double right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left.x(), middle, right),
                operator.applyAsDouble(left.y(), middle, right)
        );
    ...
    public static double apply(DoubleTernaryOperator operator, DoubleBinaryOperator consolidator, double left, Vector2.Accessible middle, Vector2.Accessible right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left, middle.x(), right.x()),
                operator.applyAsDouble(left, middle.y(), right.y())
        );
    ...
    public static double apply(DoubleTernaryOperator operator, DoubleBinaryOperator consolidator, double left, Vector2.Accessible middle, double right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left, middle.x(), right),
                operator.applyAsDouble(left, middle.y(), right)
        );
    ...
    public static double apply(DoubleTernaryOperator operator, DoubleBinaryOperator consolidator, double left, double middle, Vector2.Accessible right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left, middle, right.x()),
                operator.applyAsDouble(left, middle, right.y())
        );
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleBinaryOperator consolidator, Vector2.Accessible first, Vector2.Accessible second, Vector2.Accessible third, Vector2.Accessible fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first.x(), second.x(), third.x(), fourth.x()),
                operator.applyAsDouble(first.y(), second.y(), third.y(), fourth.y())
        );
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleBinaryOperator consolidator, Vector2.Accessible first, Vector2.Accessible second, Vector2.Accessible third, double fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first.x(), second.x(), third.x(), fourth),
                operator.applyAsDouble(first.y(), second.y(), third.y(), fourth)
        );
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleBinaryOperator consolidator, Vector2.Accessible first, Vector2.Accessible second, double third, Vector2.Accessible fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first.x(), second.x(), third, fourth.x()),
                operator.applyAsDouble(first.y(), second.y(), third, fourth.y())
        );
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleBinaryOperator consolidator, Vector2.Accessible first, Vector2.Accessible second, double third, double fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first.x(), second.x(), third, fourth),
                operator.applyAsDouble(first.y(), second.y(), third, fourth)
        );
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleBinaryOperator consolidator, Vector2.Accessible first, double second, Vector2.Accessible third, Vector2.Accessible fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first.x(), second, third.x(), fourth.x()),
                operator.applyAsDouble(first.y(), second, third.y(), fourth.y())
        );
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleBinaryOperator consolidator, Vector2.Accessible first, double second, Vector2.Accessible third, double fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first.x(), second, third.x(), fourth),
                operator.applyAsDouble(first.y(), second, third.y(), fourth)
        );
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleBinaryOperator consolidator, Vector2.Accessible first, double second, double third, Vector2.Accessible fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first.x(), second, third, fourth.x()),
                operator.applyAsDouble(first.y(), second, third, fourth.y())
        );
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleBinaryOperator consolidator, Vector2.Accessible first, double second, double third, double fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first.x(), second, third, fourth),
                operator.applyAsDouble(first.y(), second, third, fourth)
        );
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleBinaryOperator consolidator, double first, Vector2.Accessible second, Vector2.Accessible third, Vector2.Accessible fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first, second.x(), third.x(), fourth.x()),
                operator.applyAsDouble(first, second.y(), third.y(), fourth.y())
        );
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleBinaryOperator consolidator, double first, Vector2.Accessible second, Vector2.Accessible third, double fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first, second.x(), third.x(), fourth),
                operator.applyAsDouble(first, second.y(), third.y(), fourth)
        );
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleBinaryOperator consolidator, double first, Vector2.Accessible second, double third, Vector2.Accessible fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first, second.x(), third, fourth.x()),
                operator.applyAsDouble(first, second.y(), third, fourth.y())
        );
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleBinaryOperator consolidator, double first, Vector2.Accessible second, double third, double fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first, second.x(), third, fourth),
                operator.applyAsDouble(first, second.y(), third, fourth)
        );
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleBinaryOperator consolidator, double first, double second, Vector2.Accessible third, Vector2.Accessible fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first, second, third.x(), fourth.x()),
                operator.applyAsDouble(first, second, third.y(), fourth.y())
        );
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleBinaryOperator consolidator, double first, double second, Vector2.Accessible third, double fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first, second, third.x(), fourth),
                operator.applyAsDouble(first, second, third.y(), fourth)
        );
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleBinaryOperator consolidator, double first, double second, double third, Vector2.Accessible fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first, second, third, fourth.x()),
                operator.applyAsDouble(first, second, third, fourth.y())
        );
    ...
    public static double apply(DoubleUnaryOperator operator, DoubleTernaryOperator consolidator, Vector3.Accessible operand) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(operand.x()),
                operator.applyAsDouble(operand.y()),
                operator.applyAsDouble(operand.z())
    ...
    public static double apply(DoubleBinaryOperator operator, DoubleTernaryOperator consolidator, Vector3.Accessible left, Vector3.Accessible right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left.x(), right.x()),
                operator.applyAsDouble(left.y(), right.y()),
                operator.applyAsDouble(left.z(), right.z())
    ...
    public static double apply(DoubleBinaryOperator operator, DoubleTernaryOperator consolidator, Vector3.Accessible left, double right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left.x(), right),
                operator.applyAsDouble(left.y(), right),
                operator.applyAsDouble(left.z(), right)
    ...
    public static double apply(DoubleBinaryOperator operator, DoubleTernaryOperator consolidator, double left, Vector3.Accessible right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left, right.x()),
                operator.applyAsDouble(left, right.y()),
                operator.applyAsDouble(left, right.z())
    ...
    public static double apply(DoubleTernaryOperator operator, DoubleTernaryOperator consolidator, Vector3.Accessible left, Vector3.Accessible middle, Vector3.Accessible right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left.x(), middle.x(), right.x()),
                operator.applyAsDouble(left.y(), middle.y(), right.y()),
                operator.applyAsDouble(left.z(), middle.z(), right.z())
    ...
    public static double apply(DoubleTernaryOperator operator, DoubleTernaryOperator consolidator, Vector3.Accessible left, Vector3.Accessible middle, double right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left.x(), middle.x(), right),
                operator.applyAsDouble(left.y(), middle.y(), right),
                operator.applyAsDouble(left.z(), middle.z(), right)
    ...
    public static double apply(DoubleTernaryOperator operator, DoubleTernaryOperator consolidator, Vector3.Accessible left, double middle, Vector3.Accessible right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left.x(), middle, right.x()),
                operator.applyAsDouble(left.y(), middle, right.y()),
                operator.applyAsDouble(left.z(), middle, right.z())
    ...
    public static double apply(DoubleTernaryOperator operator, DoubleTernaryOperator consolidator, Vector3.Accessible left, double middle, double right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left.x(), middle, right),
                operator.applyAsDouble(left.y(), middle, right),
                operator.applyAsDouble(left.z(), middle, right)
    ...
    public static double apply(DoubleTernaryOperator operator, DoubleTernaryOperator consolidator, double left, Vector3.Accessible middle, Vector3.Accessible right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left, middle.x(), right.x()),
                operator.applyAsDouble(left, middle.y(), right.y()),
                operator.applyAsDouble(left, middle.z(), right.z())
    ...
    public static double apply(DoubleTernaryOperator operator, DoubleTernaryOperator consolidator, double left, Vector3.Accessible middle, double right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left, middle.x(), right),
                operator.applyAsDouble(left, middle.y(), right),
                operator.applyAsDouble(left, middle.z(), right)
    ...
    public static double apply(DoubleTernaryOperator operator, DoubleTernaryOperator consolidator, double left, double middle, Vector3.Accessible right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left, middle, right.x()),
                operator.applyAsDouble(left, middle, right.y()),
                operator.applyAsDouble(left, middle, right.z())
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleTernaryOperator consolidator, Vector3.Accessible first, Vector3.Accessible second, Vector3.Accessible third, Vector3.Accessible fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first.x(), second.x(), third.x(), fourth.x()),
                operator.applyAsDouble(first.y(), second.y(), third.y(), fourth.y()),
                operator.applyAsDouble(first.z(), second.z(), third.z(), fourth.z())
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleTernaryOperator consolidator, Vector3.Accessible first, Vector3.Accessible second, Vector3.Accessible third, double fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first.x(), second.x(), third.x(), fourth),
                operator.applyAsDouble(first.y(), second.y(), third.y(), fourth),
                operator.applyAsDouble(first.z(), second.z(), third.z(), fourth)
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleTernaryOperator consolidator, Vector3.Accessible first, Vector3.Accessible second, double third, Vector3.Accessible fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first.x(), second.x(), third, fourth.x()),
                operator.applyAsDouble(first.y(), second.y(), third, fourth.y()),
                operator.applyAsDouble(first.z(), second.z(), third, fourth.z())
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleTernaryOperator consolidator, Vector3.Accessible first, Vector3.Accessible second, double third, double fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first.x(), second.x(), third, fourth),
                operator.applyAsDouble(first.y(), second.y(), third, fourth),
                operator.applyAsDouble(first.z(), second.z(), third, fourth)
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleTernaryOperator consolidator, Vector3.Accessible first, double second, Vector3.Accessible third, Vector3.Accessible fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first.x(), second, third.x(), fourth.x()),
                operator.applyAsDouble(first.y(), second, third.y(), fourth.y()),
                operator.applyAsDouble(first.z(), second, third.z(), fourth.z())
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleTernaryOperator consolidator, Vector3.Accessible first, double second, Vector3.Accessible third, double fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first.x(), second, third.x(), fourth),
                operator.applyAsDouble(first.y(), second, third.y(), fourth),
                operator.applyAsDouble(first.z(), second, third.z(), fourth)
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleTernaryOperator consolidator, Vector3.Accessible first, double second, double third, Vector3.Accessible fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first.x(), second, third, fourth.x()),
                operator.applyAsDouble(first.y(), second, third, fourth.y()),
                operator.applyAsDouble(first.z(), second, third, fourth.z())
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleTernaryOperator consolidator, Vector3.Accessible first, double second, double third, double fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first.x(), second, third, fourth),
                operator.applyAsDouble(first.y(), second, third, fourth),
                operator.applyAsDouble(first.z(), second, third, fourth)
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleTernaryOperator consolidator, double first, Vector3.Accessible second, Vector3.Accessible third, Vector3.Accessible fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first, second.x(), third.x(), fourth.x()),
                operator.applyAsDouble(first, second.y(), third.y(), fourth.y()),
                operator.applyAsDouble(first, second.z(), third.z(), fourth.z())
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleTernaryOperator consolidator, double first, Vector3.Accessible second, Vector3.Accessible third, double fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first, second.x(), third.x(), fourth),
                operator.applyAsDouble(first, second.y(), third.y(), fourth),
                operator.applyAsDouble(first, second.z(), third.z(), fourth)
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleTernaryOperator consolidator, double first, Vector3.Accessible second, double third, Vector3.Accessible fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first, second.x(), third, fourth.x()),
                operator.applyAsDouble(first, second.y(), third, fourth.y()),
                operator.applyAsDouble(first, second.z(), third, fourth.z())
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleTernaryOperator consolidator, double first, Vector3.Accessible second, double third, double fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first, second.x(), third, fourth),
                operator.applyAsDouble(first, second.y(), third, fourth),
                operator.applyAsDouble(first, second.z(), third, fourth)
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleTernaryOperator consolidator, double first, double second, Vector3.Accessible third, Vector3.Accessible fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first, second, third.x(), fourth.x()),
                operator.applyAsDouble(first, second, third.y(), fourth.y()),
                operator.applyAsDouble(first, second, third.z(), fourth.z())
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleTernaryOperator consolidator, double first, double second, Vector3.Accessible third, double fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first, second, third.x(), fourth),
                operator.applyAsDouble(first, second, third.y(), fourth),
                operator.applyAsDouble(first, second, third.z(), fourth)
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleTernaryOperator consolidator, double first, double second, double third, Vector3.Accessible fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first, second, third, fourth.x()),
                operator.applyAsDouble(first, second, third, fourth.y()),
                operator.applyAsDouble(first, second, third, fourth.z())
    ...
    public static double apply(DoubleUnaryOperator operator, DoubleQuaternaryOperator consolidator, Vector4.Accessible operand) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(operand.x()),
                operator.applyAsDouble(operand.y()),
                operator.applyAsDouble(operand.z()),
    ...
    public static double apply(DoubleBinaryOperator operator, DoubleQuaternaryOperator consolidator, Vector4.Accessible left, Vector4.Accessible right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left.x(), right.x()),
                operator.applyAsDouble(left.y(), right.y()),
                operator.applyAsDouble(left.z(), right.z()),
    ...
    public static double apply(DoubleBinaryOperator operator, DoubleQuaternaryOperator consolidator, Vector4.Accessible left, double right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left.x(), right),
                operator.applyAsDouble(left.y(), right),
                operator.applyAsDouble(left.z(), right),
    ...
    public static double apply(DoubleBinaryOperator operator, DoubleQuaternaryOperator consolidator, double left, Vector4.Accessible right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left, right.x()),
                operator.applyAsDouble(left, right.y()),
                operator.applyAsDouble(left, right.z()),
    ...
    public static double apply(DoubleTernaryOperator operator, DoubleQuaternaryOperator consolidator, Vector4.Accessible left, Vector4.Accessible middle, Vector4.Accessible right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left.x(), middle.x(), right.x()),
                operator.applyAsDouble(left.y(), middle.y(), right.y()),
                operator.applyAsDouble(left.z(), middle.z(), right.z()),
    ...
    public static double apply(DoubleTernaryOperator operator, DoubleQuaternaryOperator consolidator, Vector4.Accessible left, Vector4.Accessible middle, double right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left.x(), middle.x(), right),
                operator.applyAsDouble(left.y(), middle.y(), right),
                operator.applyAsDouble(left.z(), middle.z(), right),
    ...
    public static double apply(DoubleTernaryOperator operator, DoubleQuaternaryOperator consolidator, Vector4.Accessible left, double middle, Vector4.Accessible right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left.x(), middle, right.x()),
                operator.applyAsDouble(left.y(), middle, right.y()),
                operator.applyAsDouble(left.z(), middle, right.z()),
    ...
    public static double apply(DoubleTernaryOperator operator, DoubleQuaternaryOperator consolidator, Vector4.Accessible left, double middle, double right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left.x(), middle, right),
                operator.applyAsDouble(left.y(), middle, right),
                operator.applyAsDouble(left.z(), middle, right),
    ...
    public static double apply(DoubleTernaryOperator operator, DoubleQuaternaryOperator consolidator, double left, Vector4.Accessible middle, Vector4.Accessible right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left, middle.x(), right.x()),
                operator.applyAsDouble(left, middle.y(), right.y()),
                operator.applyAsDouble(left, middle.z(), right.z()),
    ...
    public static double apply(DoubleTernaryOperator operator, DoubleQuaternaryOperator consolidator, double left, Vector4.Accessible middle, double right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left, middle.x(), right),
                operator.applyAsDouble(left, middle.y(), right),
                operator.applyAsDouble(left, middle.z(), right),
    ...
    public static double apply(DoubleTernaryOperator operator, DoubleQuaternaryOperator consolidator, double left, double middle, Vector4.Accessible right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left, middle, right.x()),
                operator.applyAsDouble(left, middle, right.y()),
                operator.applyAsDouble(left, middle, right.z()),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleQuaternaryOperator consolidator, Vector4.Accessible first, Vector4.Accessible second, Vector4.Accessible third, Vector4.Accessible fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first.x(), second.x(), third.x(), fourth.x()),
                operator.applyAsDouble(first.y(), second.y(), third.y(), fourth.y()),
                operator.applyAsDouble(first.z(), second.z(), third.z(), fourth.z()),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleQuaternaryOperator consolidator, Vector4.Accessible first, Vector4.Accessible second, Vector4.Accessible third, double fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first.x(), second.x(), third.x(), fourth),
                operator.applyAsDouble(first.y(), second.y(), third.y(), fourth),
                operator.applyAsDouble(first.z(), second.z(), third.z(), fourth),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleQuaternaryOperator consolidator, Vector4.Accessible first, Vector4.Accessible second, double third, Vector4.Accessible fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first.x(), second.x(), third, fourth.x()),
                operator.applyAsDouble(first.y(), second.y(), third, fourth.y()),
                operator.applyAsDouble(first.z(), second.z(), third, fourth.z()),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleQuaternaryOperator consolidator, Vector4.Accessible first, Vector4.Accessible second, double third, double fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first.x(), second.x(), third, fourth),
                operator.applyAsDouble(first.y(), second.y(), third, fourth),
                operator.applyAsDouble(first.z(), second.z(), third, fourth),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleQuaternaryOperator consolidator, Vector4.Accessible first, double second, Vector4.Accessible third, Vector4.Accessible fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first.x(), second, third.x(), fourth.x()),
                operator.applyAsDouble(first.y(), second, third.y(), fourth.y()),
                operator.applyAsDouble(first.z(), second, third.z(), fourth.z()),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleQuaternaryOperator consolidator, Vector4.Accessible first, double second, Vector4.Accessible third, double fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first.x(), second, third.x(), fourth),
                operator.applyAsDouble(first.y(), second, third.y(), fourth),
                operator.applyAsDouble(first.z(), second, third.z(), fourth),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleQuaternaryOperator consolidator, Vector4.Accessible first, double second, double third, Vector4.Accessible fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first.x(), second, third, fourth.x()),
                operator.applyAsDouble(first.y(), second, third, fourth.y()),
                operator.applyAsDouble(first.z(), second, third, fourth.z()),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleQuaternaryOperator consolidator, Vector4.Accessible first, double second, double third, double fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first.x(), second, third, fourth),
                operator.applyAsDouble(first.y(), second, third, fourth),
                operator.applyAsDouble(first.z(), second, third, fourth),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleQuaternaryOperator consolidator, double first, Vector4.Accessible second, Vector4.Accessible third, Vector4.Accessible fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first, second.x(), third.x(), fourth.x()),
                operator.applyAsDouble(first, second.y(), third.y(), fourth.y()),
                operator.applyAsDouble(first, second.z(), third.z(), fourth.z()),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleQuaternaryOperator consolidator, double first, Vector4.Accessible second, Vector4.Accessible third, double fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first, second.x(), third.x(), fourth),
                operator.applyAsDouble(first, second.y(), third.y(), fourth),
                operator.applyAsDouble(first, second.z(), third.z(), fourth),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleQuaternaryOperator consolidator, double first, Vector4.Accessible second, double third, Vector4.Accessible fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first, second.x(), third, fourth.x()),
                operator.applyAsDouble(first, second.y(), third, fourth.y()),
                operator.applyAsDouble(first, second.z(), third, fourth.z()),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleQuaternaryOperator consolidator, double first, Vector4.Accessible second, double third, double fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first, second.x(), third, fourth),
                operator.applyAsDouble(first, second.y(), third, fourth),
                operator.applyAsDouble(first, second.z(), third, fourth),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleQuaternaryOperator consolidator, double first, double second, Vector4.Accessible third, Vector4.Accessible fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first, second, third.x(), fourth.x()),
                operator.applyAsDouble(first, second, third.y(), fourth.y()),
                operator.applyAsDouble(first, second, third.z(), fourth.z()),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleQuaternaryOperator consolidator, double first, double second, Vector4.Accessible third, double fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first, second, third.x(), fourth),
                operator.applyAsDouble(first, second, third.y(), fourth),
                operator.applyAsDouble(first, second, third.z(), fourth),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleQuaternaryOperator consolidator, double first, double second, double third, Vector4.Accessible fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first, second, third, fourth.x()),
                operator.applyAsDouble(first, second, third, fourth.y()),
                operator.applyAsDouble(first, second, third, fourth.z()),
    ...
    public static double apply(DoubleQuaternaryOperator consolidator, Matrix2x2.Accessible matrix) {
        return consolidator.applyAsDouble(
                matrix.Xx(), matrix.Xy(),
                matrix.Yx(), matrix.Yy()
        );
    ...
    public static double apply(DoubleNovenaryOperator consolidator, Matrix3x3.Accessible matrix) {
        return consolidator.applyAsDouble(
    ...
    public static double apply(DoubleHexadecenaryOperator consolidator, Matrix4x4.Accessible matrix) {
        return consolidator.applyAsDouble(
    ...
    public static double apply(DoubleUnaryOperator operator, DoubleQuaternaryOperator consolidator, Matrix2x2.Accessible operand) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(operand.Xx()),
                operator.applyAsDouble(operand.Xy()),
                operator.applyAsDouble(operand.Yx()),
    ...
    public static double apply(DoubleBinaryOperator operator, DoubleQuaternaryOperator consolidator, Matrix2x2.Accessible left, Matrix2x2.Accessible right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left.Xx(), right.Xx()),
                operator.applyAsDouble(left.Xy(), right.Xy()),
                operator.applyAsDouble(left.Yx(), right.Yx()),
    ...
    public static double apply(DoubleBinaryOperator operator, DoubleQuaternaryOperator consolidator, Matrix2x2.Accessible left, double right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left.Xx(), right),
                operator.applyAsDouble(left.Xy(), right),
                operator.applyAsDouble(left.Yx(), right),
    ...
    public static double apply(DoubleBinaryOperator operator, DoubleQuaternaryOperator consolidator, double left, Matrix2x2.Accessible right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left, right.Xx()),
                operator.applyAsDouble(left, right.Xy()),
                operator.applyAsDouble(left, right.Yx()),
    ...
    public static double apply(DoubleTernaryOperator operator, DoubleQuaternaryOperator consolidator, Matrix2x2.Accessible left, Matrix2x2.Accessible middle, Matrix2x2.Accessible right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left.Xx(), middle.Xx(), right.Xx()),
                operator.applyAsDouble(left.Xy(), middle.Xy(), right.Xy()),
                operator.applyAsDouble(left.Yx(), middle.Yx(), right.Yx()),
    ...
    public static double apply(DoubleTernaryOperator operator, DoubleQuaternaryOperator consolidator, Matrix2x2.Accessible left, Matrix2x2.Accessible middle, double right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left.Xx(), middle.Xx(), right),
                operator.applyAsDouble(left.Xy(), middle.Xy(), right),
                operator.applyAsDouble(left.Yx(), middle.Yx(), right),
    ...
    public static double apply(DoubleTernaryOperator operator, DoubleQuaternaryOperator consolidator, Matrix2x2.Accessible left, double middle, Matrix2x2.Accessible right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left.Xx(), middle, right.Xx()),
                operator.applyAsDouble(left.Xy(), middle, right.Xy()),
                operator.applyAsDouble(left.Yx(), middle, right.Yx()),
    ...
    public static double apply(DoubleTernaryOperator operator, DoubleQuaternaryOperator consolidator, Matrix2x2.Accessible left, double middle, double right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left.Xx(), middle, right),
                operator.applyAsDouble(left.Xy(), middle, right),
                operator.applyAsDouble(left.Yx(), middle, right),
    ...
    public static double apply(DoubleTernaryOperator operator, DoubleQuaternaryOperator consolidator, double left, Matrix2x2.Accessible middle, Matrix2x2.Accessible right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left, middle.Xx(), right.Xx()),
                operator.applyAsDouble(left, middle.Xy(), right.Xy()),
                operator.applyAsDouble(left, middle.Yx(), right.Yx()),
    ...
    public static double apply(DoubleTernaryOperator operator, DoubleQuaternaryOperator consolidator, double left, Matrix2x2.Accessible middle, double right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left, middle.Xx(), right),
                operator.applyAsDouble(left, middle.Xy(), right),
                operator.applyAsDouble(left, middle.Yx(), right),
    ...
    public static double apply(DoubleTernaryOperator operator, DoubleQuaternaryOperator consolidator, double left, double middle, Matrix2x2.Accessible right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left, middle, right.Xx()),
                operator.applyAsDouble(left, middle, right.Xy()),
                operator.applyAsDouble(left, middle, right.Yx()),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleQuaternaryOperator consolidator, Matrix2x2.Accessible first, Matrix2x2.Accessible second, Matrix2x2.Accessible third, Matrix2x2.Accessible fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first.Xx(), second.Xx(), third.Xx(), fourth.Xx()),
                operator.applyAsDouble(first.Xy(), second.Xy(), third.Xy(), fourth.Xy()),
                operator.applyAsDouble(first.Yx(), second.Yx(), third.Yx(), fourth.Yx()),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleQuaternaryOperator consolidator, Matrix2x2.Accessible first, Matrix2x2.Accessible second, Matrix2x2.Accessible third, double fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first.Xx(), second.Xx(), third.Xx(), fourth),
                operator.applyAsDouble(first.Xy(), second.Xy(), third.Xy(), fourth),
                operator.applyAsDouble(first.Yx(), second.Yx(), third.Yx(), fourth),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleQuaternaryOperator consolidator, Matrix2x2.Accessible first, Matrix2x2.Accessible second, double third, Matrix2x2.Accessible fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first.Xx(), second.Xx(), third, fourth.Xx()),
                operator.applyAsDouble(first.Xy(), second.Xy(), third, fourth.Xy()),
                operator.applyAsDouble(first.Yx(), second.Yx(), third, fourth.Yx()),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleQuaternaryOperator consolidator, Matrix2x2.Accessible first, Matrix2x2.Accessible second, double third, double fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first.Xx(), second.Xx(), third, fourth),
                operator.applyAsDouble(first.Xy(), second.Xy(), third, fourth),
                operator.applyAsDouble(first.Yx(), second.Yx(), third, fourth),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleQuaternaryOperator consolidator, Matrix2x2.Accessible first, double second, Matrix2x2.Accessible third, Matrix2x2.Accessible fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first.Xx(), second, third.Xx(), fourth.Xx()),
                operator.applyAsDouble(first.Xy(), second, third.Xy(), fourth.Xy()),
                operator.applyAsDouble(first.Yx(), second, third.Yx(), fourth.Yx()),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleQuaternaryOperator consolidator, Matrix2x2.Accessible first, double second, Matrix2x2.Accessible third, double fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first.Xx(), second, third.Xx(), fourth),
                operator.applyAsDouble(first.Xy(), second, third.Xy(), fourth),
                operator.applyAsDouble(first.Yx(), second, third.Yx(), fourth),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleQuaternaryOperator consolidator, Matrix2x2.Accessible first, double second, double third, Matrix2x2.Accessible fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first.Xx(), second, third, fourth.Xx()),
                operator.applyAsDouble(first.Xy(), second, third, fourth.Xy()),
                operator.applyAsDouble(first.Yx(), second, third, fourth.Yx()),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleQuaternaryOperator consolidator, Matrix2x2.Accessible first, double second, double third, double fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first.Xx(), second, third, fourth),
                operator.applyAsDouble(first.Xy(), second, third, fourth),
                operator.applyAsDouble(first.Yx(), second, third, fourth),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleQuaternaryOperator consolidator, double first, Matrix2x2.Accessible second, Matrix2x2.Accessible third, Matrix2x2.Accessible fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first, second.Xx(), third.Xx(), fourth.Xx()),
                operator.applyAsDouble(first, second.Xy(), third.Xy(), fourth.Xy()),
                operator.applyAsDouble(first, second.Yx(), third.Yx(), fourth.Yx()),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleQuaternaryOperator consolidator, double first, Matrix2x2.Accessible second, Matrix2x2.Accessible third, double fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first, second.Xx(), third.Xx(), fourth),
                operator.applyAsDouble(first, second.Xy(), third.Xy(), fourth),
                operator.applyAsDouble(first, second.Yx(), third.Yx(), fourth),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleQuaternaryOperator consolidator, double first, Matrix2x2.Accessible second, double third, Matrix2x2.Accessible fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first, second.Xx(), third, fourth.Xx()),
                operator.applyAsDouble(first, second.Xy(), third, fourth.Xy()),
                operator.applyAsDouble(first, second.Yx(), third, fourth.Yx()),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleQuaternaryOperator consolidator, double first, Matrix2x2.Accessible second, double third, double fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first, second.Xx(), third, fourth),
                operator.applyAsDouble(first, second.Xy(), third, fourth),
                operator.applyAsDouble(first, second.Yx(), third, fourth),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleQuaternaryOperator consolidator, double first, double second, Matrix2x2.Accessible third, Matrix2x2.Accessible fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first, second, third.Xx(), fourth.Xx()),
                operator.applyAsDouble(first, second, third.Xy(), fourth.Xy()),
                operator.applyAsDouble(first, second, third.Yx(), fourth.Yx()),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleQuaternaryOperator consolidator, double first, double second, Matrix2x2.Accessible third, double fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first, second, third.Xx(), fourth),
                operator.applyAsDouble(first, second, third.Xy(), fourth),
                operator.applyAsDouble(first, second, third.Yx(), fourth),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleQuaternaryOperator consolidator, double first, double second, double third, Matrix2x2.Accessible fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first, second, third, fourth.Xx()),
                operator.applyAsDouble(first, second, third, fourth.Xy()),
                operator.applyAsDouble(first, second, third, fourth.Yx()),
    ...
    public static double apply(DoubleUnaryOperator operator, DoubleNovenaryOperator consolidator, Matrix3x3.Accessible operand) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(operand.Xx()),
                operator.applyAsDouble(operand.Xy()),
                operator.applyAsDouble(operand.Xz()),
    ...
    public static double apply(DoubleBinaryOperator operator, DoubleNovenaryOperator consolidator, Matrix3x3.Accessible left, Matrix3x3.Accessible right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left.Xx(), right.Xx()),
                operator.applyAsDouble(left.Xy(), right.Xy()),
                operator.applyAsDouble(left.Xz(), right.Xz()),
    ...
    public static double apply(DoubleBinaryOperator operator, DoubleNovenaryOperator consolidator, Matrix3x3.Accessible left, double right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left.Xx(), right),
                operator.applyAsDouble(left.Xy(), right),
                operator.applyAsDouble(left.Xz(), right),
    ...
    public static double apply(DoubleBinaryOperator operator, DoubleNovenaryOperator consolidator, double left, Matrix3x3.Accessible right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left, right.Xx()),
                operator.applyAsDouble(left, right.Xy()),
                operator.applyAsDouble(left, right.Xz()),
    ...
    public static double apply(DoubleTernaryOperator operator, DoubleNovenaryOperator consolidator, Matrix3x3.Accessible left, Matrix3x3.Accessible middle, Matrix3x3.Accessible right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left.Xx(), middle.Xx(), right.Xx()),
                operator.applyAsDouble(left.Xy(), middle.Xy(), right.Xy()),
                operator.applyAsDouble(left.Xz(), middle.Xz(), right.Xz()),
    ...
    public static double apply(DoubleTernaryOperator operator, DoubleNovenaryOperator consolidator, Matrix3x3.Accessible left, Matrix3x3.Accessible middle, double right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left.Xx(), middle.Xx(), right),
                operator.applyAsDouble(left.Xy(), middle.Xy(), right),
                operator.applyAsDouble(left.Xz(), middle.Xz(), right),
    ...
    public static double apply(DoubleTernaryOperator operator, DoubleNovenaryOperator consolidator, Matrix3x3.Accessible left, double middle, Matrix3x3.Accessible right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left.Xx(), middle, right.Xx()),
                operator.applyAsDouble(left.Xy(), middle, right.Xy()),
                operator.applyAsDouble(left.Xz(), middle, right.Xz()),
    ...
    public static double apply(DoubleTernaryOperator operator, DoubleNovenaryOperator consolidator, Matrix3x3.Accessible left, double middle, double right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left.Xx(), middle, right),
                operator.applyAsDouble(left.Xy(), middle, right),
                operator.applyAsDouble(left.Xz(), middle, right),
    ...
    public static double apply(DoubleTernaryOperator operator, DoubleNovenaryOperator consolidator, double left, Matrix3x3.Accessible middle, Matrix3x3.Accessible right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left, middle.Xx(), right.Xx()),
                operator.applyAsDouble(left, middle.Xy(), right.Xy()),
                operator.applyAsDouble(left, middle.Xz(), right.Xz()),
    ...
    public static double apply(DoubleTernaryOperator operator, DoubleNovenaryOperator consolidator, double left, Matrix3x3.Accessible middle, double right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left, middle.Xx(), right),
                operator.applyAsDouble(left, middle.Xy(), right),
                operator.applyAsDouble(left, middle.Xz(), right),
    ...
    public static double apply(DoubleTernaryOperator operator, DoubleNovenaryOperator consolidator, double left, double middle, Matrix3x3.Accessible right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left, middle, right.Xx()),
                operator.applyAsDouble(left, middle, right.Xy()),
                operator.applyAsDouble(left, middle, right.Xz()),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleNovenaryOperator consolidator, Matrix3x3.Accessible first, Matrix3x3.Accessible second, Matrix3x3.Accessible third, Matrix3x3.Accessible fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first.Xx(), second.Xx(), third.Xx(), fourth.Xx()),
                operator.applyAsDouble(first.Xy(), second.Xy(), third.Xy(), fourth.Xy()),
                operator.applyAsDouble(first.Xz(), second.Xz(), third.Xz(), fourth.Xz()),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleNovenaryOperator consolidator, Matrix3x3.Accessible first, Matrix3x3.Accessible second, Matrix3x3.Accessible third, double fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first.Xx(), second.Xx(), third.Xx(), fourth),
                operator.applyAsDouble(first.Xy(), second.Xy(), third.Xy(), fourth),
                operator.applyAsDouble(first.Xz(), second.Xz(), third.Xz(), fourth),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleNovenaryOperator consolidator, Matrix3x3.Accessible first, Matrix3x3.Accessible second, double third, Matrix3x3.Accessible fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first.Xx(), second.Xx(), third, fourth.Xx()),
                operator.applyAsDouble(first.Xy(), second.Xy(), third, fourth.Xy()),
                operator.applyAsDouble(first.Xz(), second.Xz(), third, fourth.Xz()),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleNovenaryOperator consolidator, Matrix3x3.Accessible first, Matrix3x3.Accessible second, double third, double fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first.Xx(), second.Xx(), third, fourth),
                operator.applyAsDouble(first.Xy(), second.Xy(), third, fourth),
                operator.applyAsDouble(first.Xz(), second.Xz(), third, fourth),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleNovenaryOperator consolidator, Matrix3x3.Accessible first, double second, Matrix3x3.Accessible third, Matrix3x3.Accessible fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first.Xx(), second, third.Xx(), fourth.Xx()),
                operator.applyAsDouble(first.Xy(), second, third.Xy(), fourth.Xy()),
                operator.applyAsDouble(first.Xz(), second, third.Xz(), fourth.Xz()),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleNovenaryOperator consolidator, Matrix3x3.Accessible first, double second, Matrix3x3.Accessible third, double fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first.Xx(), second, third.Xx(), fourth),
                operator.applyAsDouble(first.Xy(), second, third.Xy(), fourth),
                operator.applyAsDouble(first.Xz(), second, third.Xz(), fourth),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleNovenaryOperator consolidator, Matrix3x3.Accessible first, double second, double third, Matrix3x3.Accessible fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first.Xx(), second, third, fourth.Xx()),
                operator.applyAsDouble(first.Xy(), second, third, fourth.Xy()),
                operator.applyAsDouble(first.Xz(), second, third, fourth.Xz()),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleNovenaryOperator consolidator, Matrix3x3.Accessible first, double second, double third, double fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first.Xx(), second, third, fourth),
                operator.applyAsDouble(first.Xy(), second, third, fourth),
                operator.applyAsDouble(first.Xz(), second, third, fourth),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleNovenaryOperator consolidator, double first, Matrix3x3.Accessible second, Matrix3x3.Accessible third, Matrix3x3.Accessible fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first, second.Xx(), third.Xx(), fourth.Xx()),
                operator.applyAsDouble(first, second.Xy(), third.Xy(), fourth.Xy()),
                operator.applyAsDouble(first, second.Xz(), third.Xz(), fourth.Xz()),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleNovenaryOperator consolidator, double first, Matrix3x3.Accessible second, Matrix3x3.Accessible third, double fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first, second.Xx(), third.Xx(), fourth),
                operator.applyAsDouble(first, second.Xy(), third.Xy(), fourth),
                operator.applyAsDouble(first, second.Xz(), third.Xz(), fourth),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleNovenaryOperator consolidator, double first, Matrix3x3.Accessible second, double third, Matrix3x3.Accessible fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first, second.Xx(), third, fourth.Xx()),
                operator.applyAsDouble(first, second.Xy(), third, fourth.Xy()),
                operator.applyAsDouble(first, second.Xz(), third, fourth.Xz()),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleNovenaryOperator consolidator, double first, Matrix3x3.Accessible second, double third, double fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first, second.Xx(), third, fourth),
                operator.applyAsDouble(first, second.Xy(), third, fourth),
                operator.applyAsDouble(first, second.Xz(), third, fourth),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleNovenaryOperator consolidator, double first, double second, Matrix3x3.Accessible third, Matrix3x3.Accessible fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first, second, third.Xx(), fourth.Xx()),
                operator.applyAsDouble(first, second, third.Xy(), fourth.Xy()),
                operator.applyAsDouble(first, second, third.Xz(), fourth.Xz()),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleNovenaryOperator consolidator, double first, double second, Matrix3x3.Accessible third, double fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first, second, third.Xx(), fourth),
                operator.applyAsDouble(first, second, third.Xy(), fourth),
                operator.applyAsDouble(first, second, third.Xz(), fourth),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleNovenaryOperator consolidator, double first, double second, double third, Matrix3x3.Accessible fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first, second, third, fourth.Xx()),
                operator.applyAsDouble(first, second, third, fourth.Xy()),
                operator.applyAsDouble(first, second, third, fourth.Xz()),
    ...
    public static double apply(DoubleUnaryOperator operator, DoubleHexadecenaryOperator consolidator, Matrix4x4.Accessible operand) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(operand.Xx()),
                operator.applyAsDouble(operand.Xy()),
                operator.applyAsDouble(operand.Xz()),
    ...
    public static double apply(DoubleBinaryOperator operator, DoubleHexadecenaryOperator consolidator, Matrix4x4.Accessible left, Matrix4x4.Accessible right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left.Xx(), right.Xx()),
                operator.applyAsDouble(left.Xy(), right.Xy()),
                operator.applyAsDouble(left.Xz(), right.Xz()),
    ...
    public static double apply(DoubleBinaryOperator operator, DoubleHexadecenaryOperator consolidator, Matrix4x4.Accessible left, double right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left.Xx(), right),
                operator.applyAsDouble(left.Xy(), right),
                operator.applyAsDouble(left.Xz(), right),
    ...
    public static double apply(DoubleBinaryOperator operator, DoubleHexadecenaryOperator consolidator, double left, Matrix4x4.Accessible right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left, right.Xx()),
                operator.applyAsDouble(left, right.Xy()),
                operator.applyAsDouble(left, right.Xz()),
    ...
    public static double apply(DoubleTernaryOperator operator, DoubleHexadecenaryOperator consolidator, Matrix4x4.Accessible left, Matrix4x4.Accessible middle, Matrix4x4.Accessible right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left.Xx(), middle.Xx(), right.Xx()),
                operator.applyAsDouble(left.Xy(), middle.Xy(), right.Xy()),
                operator.applyAsDouble(left.Xz(), middle.Xz(), right.Xz()),
    ...
    public static double apply(DoubleTernaryOperator operator, DoubleHexadecenaryOperator consolidator, Matrix4x4.Accessible left, Matrix4x4.Accessible middle, double right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left.Xx(), middle.Xx(), right),
                operator.applyAsDouble(left.Xy(), middle.Xy(), right),
                operator.applyAsDouble(left.Xz(), middle.Xz(), right),
    ...
    public static double apply(DoubleTernaryOperator operator, DoubleHexadecenaryOperator consolidator, Matrix4x4.Accessible left, double middle, Matrix4x4.Accessible right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left.Xx(), middle, right.Xx()),
                operator.applyAsDouble(left.Xy(), middle, right.Xy()),
                operator.applyAsDouble(left.Xz(), middle, right.Xz()),
    ...
    public static double apply(DoubleTernaryOperator operator, DoubleHexadecenaryOperator consolidator, Matrix4x4.Accessible left, double middle, double right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left.Xx(), middle, right),
                operator.applyAsDouble(left.Xy(), middle, right),
                operator.applyAsDouble(left.Xz(), middle, right),
    ...
    public static double apply(DoubleTernaryOperator operator, DoubleHexadecenaryOperator consolidator, double left, Matrix4x4.Accessible middle, Matrix4x4.Accessible right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left, middle.Xx(), right.Xx()),
                operator.applyAsDouble(left, middle.Xy(), right.Xy()),
                operator.applyAsDouble(left, middle.Xz(), right.Xz()),
    ...
    public static double apply(DoubleTernaryOperator operator, DoubleHexadecenaryOperator consolidator, double left, Matrix4x4.Accessible middle, double right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left, middle.Xx(), right),
                operator.applyAsDouble(left, middle.Xy(), right),
                operator.applyAsDouble(left, middle.Xz(), right),
    ...
    public static double apply(DoubleTernaryOperator operator, DoubleHexadecenaryOperator consolidator, double left, double middle, Matrix4x4.Accessible right) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(left, middle, right.Xx()),
                operator.applyAsDouble(left, middle, right.Xy()),
                operator.applyAsDouble(left, middle, right.Xz()),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleHexadecenaryOperator consolidator, Matrix4x4.Accessible first, Matrix4x4.Accessible second, Matrix4x4.Accessible third, Matrix4x4.Accessible fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first.Xx(), second.Xx(), third.Xx(), fourth.Xx()),
                operator.applyAsDouble(first.Xy(), second.Xy(), third.Xy(), fourth.Xy()),
                operator.applyAsDouble(first.Xz(), second.Xz(), third.Xz(), fourth.Xz()),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleHexadecenaryOperator consolidator, Matrix4x4.Accessible first, Matrix4x4.Accessible second, Matrix4x4.Accessible third, double fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first.Xx(), second.Xx(), third.Xx(), fourth),
                operator.applyAsDouble(first.Xy(), second.Xy(), third.Xy(), fourth),
                operator.applyAsDouble(first.Xz(), second.Xz(), third.Xz(), fourth),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleHexadecenaryOperator consolidator, Matrix4x4.Accessible first, Matrix4x4.Accessible second, double third, Matrix4x4.Accessible fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first.Xx(), second.Xx(), third, fourth.Xx()),
                operator.applyAsDouble(first.Xy(), second.Xy(), third, fourth.Xy()),
                operator.applyAsDouble(first.Xz(), second.Xz(), third, fourth.Xz()),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleHexadecenaryOperator consolidator, Matrix4x4.Accessible first, Matrix4x4.Accessible second, double third, double fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first.Xx(), second.Xx(), third, fourth),
                operator.applyAsDouble(first.Xy(), second.Xy(), third, fourth),
                operator.applyAsDouble(first.Xz(), second.Xz(), third, fourth),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleHexadecenaryOperator consolidator, Matrix4x4.Accessible first, double second, Matrix4x4.Accessible third, Matrix4x4.Accessible fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first.Xx(), second, third.Xx(), fourth.Xx()),
                operator.applyAsDouble(first.Xy(), second, third.Xy(), fourth.Xy()),
                operator.applyAsDouble(first.Xz(), second, third.Xz(), fourth.Xz()),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleHexadecenaryOperator consolidator, Matrix4x4.Accessible first, double second, Matrix4x4.Accessible third, double fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first.Xx(), second, third.Xx(), fourth),
                operator.applyAsDouble(first.Xy(), second, third.Xy(), fourth),
                operator.applyAsDouble(first.Xz(), second, third.Xz(), fourth),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleHexadecenaryOperator consolidator, Matrix4x4.Accessible first, double second, double third, Matrix4x4.Accessible fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first.Xx(), second, third, fourth.Xx()),
                operator.applyAsDouble(first.Xy(), second, third, fourth.Xy()),
                operator.applyAsDouble(first.Xz(), second, third, fourth.Xz()),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleHexadecenaryOperator consolidator, Matrix4x4.Accessible first, double second, double third, double fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first.Xx(), second, third, fourth),
                operator.applyAsDouble(first.Xy(), second, third, fourth),
                operator.applyAsDouble(first.Xz(), second, third, fourth),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleHexadecenaryOperator consolidator, double first, Matrix4x4.Accessible second, Matrix4x4.Accessible third, Matrix4x4.Accessible fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first, second.Xx(), third.Xx(), fourth.Xx()),
                operator.applyAsDouble(first, second.Xy(), third.Xy(), fourth.Xy()),
                operator.applyAsDouble(first, second.Xz(), third.Xz(), fourth.Xz()),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleHexadecenaryOperator consolidator, double first, Matrix4x4.Accessible second, Matrix4x4.Accessible third, double fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first, second.Xx(), third.Xx(), fourth),
                operator.applyAsDouble(first, second.Xy(), third.Xy(), fourth),
                operator.applyAsDouble(first, second.Xz(), third.Xz(), fourth),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleHexadecenaryOperator consolidator, double first, Matrix4x4.Accessible second, double third, Matrix4x4.Accessible fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first, second.Xx(), third, fourth.Xx()),
                operator.applyAsDouble(first, second.Xy(), third, fourth.Xy()),
                operator.applyAsDouble(first, second.Xz(), third, fourth.Xz()),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleHexadecenaryOperator consolidator, double first, Matrix4x4.Accessible second, double third, double fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first, second.Xx(), third, fourth),
                operator.applyAsDouble(first, second.Xy(), third, fourth),
                operator.applyAsDouble(first, second.Xz(), third, fourth),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleHexadecenaryOperator consolidator, double first, double second, Matrix4x4.Accessible third, Matrix4x4.Accessible fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first, second, third.Xx(), fourth.Xx()),
                operator.applyAsDouble(first, second, third.Xy(), fourth.Xy()),
                operator.applyAsDouble(first, second, third.Xz(), fourth.Xz()),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleHexadecenaryOperator consolidator, double first, double second, Matrix4x4.Accessible third, double fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first, second, third.Xx(), fourth),
                operator.applyAsDouble(first, second, third.Xy(), fourth),
                operator.applyAsDouble(first, second, third.Xz(), fourth),
    ...
    public static double apply(DoubleQuaternaryOperator operator, DoubleHexadecenaryOperator consolidator, double first, double second, double third, Matrix4x4.Accessible fourth) {
        return consolidator.applyAsDouble(
                operator.applyAsDouble(first, second, third, fourth.Xx()),
                operator.applyAsDouble(first, second, third, fourth.Xy()),
                operator.applyAsDouble(first, second, third, fourth.Xz()),
